            ...
            <div class="page-sidebar">
                ...
                <div class="sidebar-menugroup">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sidebar-menuitem"><a href="${pageContext.request.contextPath}/SearchStaffServlet" target="main">搜索员工</a></li>
                    </ul>
                </div>              
                <div class="sidebar-menugroup">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sidebar-menuitem"><a href="${pageContext.request.contextPath}/BookMeetingJspServlet" target="main">预定会议</a></li>
